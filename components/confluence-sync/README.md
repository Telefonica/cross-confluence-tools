...
Synchronize an array of elements with HTML contents with Confluence pages. Supports nested pages and attachments upload. Also supports updating single pages with an id.
